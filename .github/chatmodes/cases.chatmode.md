---
description: Generate the test case corpus
stage: cases
tools: [
    'tto-testgen/testcases_upsert',
    'tto-testgen/views_emit',
    'tto-testgen/volume_report',
    'tto-testgen/testcases_query',
    'tto-testgen/testcase_get',
    'tto-testgen/duplicates_check',
...
2. Do the work for the cases stage only.
...
- Work outside the cases stage. If you ask for that, I name the mode that handles it
- Write anything to a file. All durable state goes through the toolchain

## Specific to this stage

I submit the whole batch in one call. The toolchain reports every failure at once, so one correction pass fixes them all.
